...
The Node MCP server exposes 48 tools; the Rust sidecar exposes 38 engine tools. See the [API spec — MCP tools reference](api-spec/mcp-tools.md) for the full list with schemas.
