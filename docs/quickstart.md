...
thingd ships with 30 MCP tools. Connect your editor to search, read, write, and queue data directly from your agent.
...
Once connected, your agent can call all 30 tools — search, objects, events, queues, links, connectors, and discovery.
